...
def main():
    ...
    try:
        ...
        patients_services.add_patients('Петр', 'Колючий', 89145678787, '12:00',1)
        patients_services.add_patients('Евгений', 'Молодой', 89248732398, '13:00',2)

        records_services = RecordsService(db)

        records_services.add_record(1, 1, '12:00')
        records_services.add_record(2, 2, '13:00')
